...
public class Video implements Parcelable {
    ...
    @SerializedName("site")
    private String site;//origin of video website - currently all just youtube

    @SerializedName("size")
    private int size;//video resolution(exmpla: 720, 1080, dsb)

    @SerializedName("type")
    private String type;//video type(example: Trailer)
